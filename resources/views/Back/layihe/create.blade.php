...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tecrube</h1>
        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.project.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="project" class="form-label">Fayl</label>
                            <input type="file" name='project' value="{{old('project')}}" class="form-control" id="project">
                        </div>
                        <span class="text-danger">@error('project'){{'Fayl sahəsi boş ola bilməz!'}}@enderror</span>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label for="text" class="form-label">Text</label>
                            <textarea id="editor" name="text" defaultValue="{{ old('text') }}" rows='4'
